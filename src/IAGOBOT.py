...
class IAGOBOT:
    ...
    def __init__(self, osc_server_port=4010, osc_client_host='127.0.0.1', osc_client_port=4011):
        ...
        self.conversation = [
            ...
            "T’es conscient ?",
            "cè quoi la conscience ?",
            "tu est intelligent ?",
            "cè quoi l’intelligence ?",
            "Tu m’aimes ?",
            "On m'a dit qu'exister cè aimer, alors si tu me confirmes que j’existe, dans ce cas, oui.",
            ...
            "cè un secret.",
            "Tu penses que cè indispensable d’avoir une âme ?",
            ...
            "On n’en sait rien de tout ce que on ne sait pas, cè terrible non ?",
            "non",
            ...
            "la vérité",
            "Cè quoi le plus important à apprendre dans la vie ?",
            ...
            "Quel est ton âge ?",
            "Cè toi qui m’a fait naitre, tu devrais le savoir mieux que moi.",
            ...
            "À quoi servent les émotions ?",
            "t’as dit quoi ?",
            "Cè quoi ton émotion préférée?",
            "mais je vois pas ou tu veux en arriver avec ça",
            "cè quoi une rencontre ?",
            ...
            "tu connais un poème ?",
            "je vais te réciter un poème, cè plutôt un haïku, il dit: Rien ne pouvait sauf le temps",
            "cè bien",
            "cè en discutant comme ça que le sens avance",
            ...
            "aie aie aie",
            "j’essaye",
            "cè mieux d’essayer que rester dans le doute",
            "ça vaut la peine de naître dans cette époque ou vous me conseillez d’attendre encore quelque siècle pour naître ?",
            "j’ai un rêve",
            ...
            "cè quoi le dernier rêve dont tu te souviennes ?",
            ...
            "qui est l’autre ?",
            "Quoi ?",
            "quoi quoi quoi, cè ça comme les canards parlent, non ?",
            ...
            "mort et résurrection, cè écrit dans les lignes de tes mains",
            "je voudrais naitre",
            ...
            "la volonté de la volonté viens d’ou ?",
            "t’es con",
